...
from database.models import db, Usuario, Rol, asignacion_rol_usuario, Insumo, Receta, SolicitudProduccion, Venta, DetalleVenta, Compra, Proveedor
...
@venta.route('/solicitud_produccion', methods=['POST'])
@login_required
